...
strTextoHtml = strTextoHtml & "Copyright(c) Jotatech Sistemas de Comércio Eletrônico" & vbNewLine
strTextoHtml = strTextoHtml & "All Rights Reserved." & vbNewLine
strTextoHtml = strTextoHtml & "------------------------------" & vbNewLine
strTextoHtml = strTextoHtml & "http://www.jotatech.com.br" & vbNewLine
...
strTextoHtml = strTextoHtml & "<tr bgcolor=#eeeeee><td><FONT face=tahoma style=font-size:11px><b>Versão Jotatech:</b></td><td><FONT face=tahoma style=font-size:11px>" & Application("vsversao") & "</td></tr>"
...
strTextoHtml = strTextoHtml & "<iframe src=""http://www.virtuaworks.com.br/virtuastore/atualizacoes.asp"" width=""100%"" height=""27"" scrolling=""no"" frameborder=""0"" marginheight=""0"" marginwidth=""0"">&nbsp;</iframe>"
...
strTextoHtml = strTextoHtml & "<a href=""http://www.jotatech.com.br"" target=_new style=text-decoration:none;><FONT face=tahoma style=font-size:11px><B>&copy; Jotatech Sistemas de Comércio Eletrônico&nbsp;</B></a></TD></TR></TBODY></TABLE>"
...
strTextoHtml = strTextoHtml & "<form action=""administrador.asp?link=suporte&acao=envia"" method=post><font style=font-size:11px;font-family:tahoma><br>Preencha seu pedido de suporte para Equipe Jotatech:<br>"
If Request("sucesso") = "sim" Then
strTextoHtml = strTextoHtml & "<br><center><b><font style=font-size:11px;font-family:tahoma;color:#003366><br>SEU PEDIDO DE SUPORTE ENVIADO COM SUCESSO! <br>EM BREVE A EQUIPE JOTATECH ESTARÁ RESPONDENDO SEU CHAMADO.<br><br><br></font></b></center>"
Else
strTextoHtml = strTextoHtml & "<br><br>"
End If
varimg = "&nbsp;<img src='adm_imagens/xis.gif' width='15' height='16' border='0' align='absmiddle'>"
